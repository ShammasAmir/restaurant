                    ...
                    <form id="contact" action="{{url('/reserve')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <fieldset>
                                    <input name="guests" type="text" id="guests" placeholder="Number of Guests">
                                </fieldset>
                            </div>
                            <div class="col-lg-6">
                                <div id="filterDate2">
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <button type="submit" name="reserve" id="form-submit" class="main-button-icon">Make A Reservation</button>
                                </fieldset>
                            </div>
                        </div>
                    </form>
