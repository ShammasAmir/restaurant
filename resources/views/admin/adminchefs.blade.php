...
<body>
    ...
    <div class="container-scroller">
        ...
        <div class="container">
            ...
            <div>
                <h2 class="m-4">Create New Chef</h2>
                <form action="{{ url('/createchef') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <input class="mt-2 mb-4" type="submit" value="Create Chef" style="background-color: green">
                    </div>
                ...
                <table bgcolor="grey" border="3px">
                    ...
                    @foreach ($data as $data)
                        <tr align="center">
                            ...
                            <td><a style="background-color: yellow" href="{{ url('/editchef', $data->id) }}">Edit</a>
                            </td>
                            <td><a style="background-color: pink" href="{{ url('/deletechef', $data->id) }}">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
