...
<body>
    ...
    <div class="container-scroller">
        ...
        <div class="container">
            ...
            <div>
                <h2 class="m-4">Create New Food</h2>
                <form action="{{ url('/createfood') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <input class="mt-2 mb-4" type="submit" value="Create Food" style="background-color: green">
                    </div>
                ...
                <table bgcolor="grey" border="3px">
                    ...
                    @foreach ($data as $data)
                        <tr align="center">
                            ...
                            <td><a style="background-color: yellow" href="{{ url('/editfood', $data->id) }}">Edit</a>
                            </td>
                            <td><a style="background-color: pink" href="{{ url('/deletefood', $data->id) }}">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
